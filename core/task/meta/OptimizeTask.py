...
from core.actor.optimizer.ESQLRefineOptimize import ESQLRefineOptimizer
...
class OptimizeTask(MetaTask):
    ...
    def load_actor(self, actor_type: str = None, **kwargs) -> Optional[BaseOptimizer]:
        ...
        elif actor_type in ("ESQLRefineOptimizer", "ESQL"):
            actor = ESQLRefineOptimizer(**optimize_args)
            return actor
