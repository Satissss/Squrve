...
from core.actor.parser.ESQLQuestionEnrichParse import ESQLQuestionEnrichParser
...
class ParseTask(MetaTask):
    ...
    def load_actor(self, actor_type: str = None, **kwargs) -> Optional[BaseParser]:
        ...
        elif actor_type in ("ESQLQuestionEnrichParser", "ESQL"):
            actor = ESQLQuestionEnrichParser(**parse_args)
            return actor
