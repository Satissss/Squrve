...
class LinkAlignReducer(BaseReducer):
    ...
    def get_retain_schema(self, schema: Union[List[Dict], pd.DataFrame]) -> pd.DataFrame:
        ...
        for n in turn_n_lis:
            ...
            df_reserver_rate = self.decay_rate * pow(self.reserve_size, n)
    ...
    def act(self, item, schema: Union[Dict, List] = None, **kwargs):
        ...
        if not self.skip_retrieval and not self.skip_post_retrieval:
        ...
        if self.skip_retrieval:
            ...
            if db_size <= self.min_retrival_size:
                ...
                sub_schema = parse_schemas_from_nodes(nodes=nodes, output_format="list")
        ...
        if not self.skip_filter:
            ...
            if not self.skip_post_retrieval:
                ...
                sub_df = parse_schemas_from_nodes(nodes=nodes, schema_source=source)
